...
- **Constructor:** where you can load plugins and create pedalboards
- **Performance:** quick view to load Pedalboard Snapshots and check all the plugins in your pedalboard (ideal for touch devices)
- **Pedalboard Library:** library where you can check all the pedalboards stored in the device
- **Banks:** place to manage pedalboard Banks for quick access from the device
