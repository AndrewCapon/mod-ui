...
- **Save:** Overwrites the current snapshot with the latest changes.
- **Save as:** Saves a new snapshot, allowing you to set its name.
- **Load/Manage:** Allows you to load a different snapshot, rename and delete snapshots	or assign them to the physical controls of your MOD device.
